    ...
    <View style={styles.container}>
      ...
      {location ? (
        <View style={styles.webMapPlaceholder}>
          <Text>Mapa no soportado en la versión Web (utiliza la app nativa o Expo Go).</Text>
          <Text>Lat/Lng simulado: {location.coords.latitude.toFixed(4)}, {location.coords.longitude.toFixed(4)}</Text>
        </View>
      ) : (
...
const styles = StyleSheet.create({
  ...
  webMapPlaceholder: { width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center', backgroundColor: '#e2e8f0', padding: 20 },
